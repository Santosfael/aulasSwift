...
public class GoDevButton: UIButton {
    ...
    private func updateDisplay() {
        ...
        setTitleColor(config.forengroundColor, for: .normal)
    }
...
public extension GoDevButton {
    struct Config {
        ...
        public let forengroundColor: UIColor
        
        public static func light() -> Config {
            Config(backgroundColor: .white, highlightedBackgroundColor: UIColor(red: 0.98, green: 0.98, blue: 1, alpha: 1), forengroundColor: UIColor(red: 0.25, green: 0.27, blue: 0.38, alpha: 1))
        }
        
        public static func dark() -> Config {
            Config(backgroundColor: UIColor(red: 0.12, green: 0.13, blue: 0.21, alpha: 1), highlightedBackgroundColor: UIColor(red: 0.09, green: 0.09, blue: 0.15, alpha: 1), forengroundColor: UIColor(red: 0.98, green: 0.98, blue: 1, alpha: 1))
        }
    }
    ...
    struct Shadow {
        ...
        public static func standard() -> Shadow {
            Shadow(offset: .init(width: 0, height: 2), radius: 3, color: UIColor(red: 0.00, green: 0.07, blue: 0.52, alpha: 1), opacity: 0.2)
        }
        
        public static func pressed() -> Shadow {
            Shadow(offset: .init(width: 0, height: 1), radius: 1, color: UIColor(red: 0, green: 0.07, blue: 0.52, alpha: 1), opacity: 0.2)
        }
    }
}
